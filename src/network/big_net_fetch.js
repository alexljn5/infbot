...
async function searchRandomImage(queryText) {
...
async function getRandomCreamImage() {
    return searchRandomImage('cream the rabbit sonic');
}

async function getRandomBigImage() {
    return searchRandomImage('big the cat sonic');
}
